...
object ServerUrls {
    ...
    const val url_regula_post_data = "ipass/plus/ocr/data"
    const val url_regula_get_dataBy_email = "ipass/plus/ocr/data"
    const val url_regula_data_get_sid = "plus/mobile/data/get/sid"
